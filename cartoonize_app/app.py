      ...
      <div style="display:flex;justify-content:space-around;margin-top:14px;">
        <div style="text-align:center;">
          <p style="font-family:'Syne',sans-serif;font-weight:700;font-size:1.15rem;
                    color:#EEEAF8;margin:0;">{len(hist)}</p>
          <p style="font-family:'Syne Mono',monospace;font-size:.5rem;color:#3E3C58;
                    text-transform:uppercase;letter-spacing:.06em;margin:1px 0 0;">Images</p>
        </div>
        <div style="width:1px;background:rgba(255,255,255,.05);"></div>
        <div style="text-align:center;">
          <p style="font-family:'Syne',sans-serif;font-weight:700;font-size:1.15rem;
                    color:#EEEAF8;margin:0;">10</p>
          <p style="font-family:'Syne Mono',monospace;font-size:.5rem;color:#3E3C58;
                    text-transform:uppercase;letter-spacing:.06em;margin:1px 0 0;">Effects</p>
        </div>
        <div style="width:1px;background:rgba(255,255,255,.05);"></div>
        <div style="text-align:center;">
          <p style="font-family:'Syne',sans-serif;font-weight:700;font-size:1.15rem;
                    color:#EEEAF8;margin:0;">{styles_used}</p>
          <p style="font-family:'Syne Mono',monospace;font-size:.5rem;color:#3E3C58;
                    text-transform:uppercase;letter-spacing:.06em;margin:1px 0 0;">Styles</p>
        </div>
      </div>
    </div>
    """, unsafe_allow_html=True)
